...
namespace HatchOS
{
    ...
    public class Kernel : Sys.Kernel
    {
        ...
        public static float AudioVolume = 1f; // Max value should be 1f (or 100 percent volume; values range from 0f to 1f)
        ...
        public static void TimerCallback()
        {
            ...
            for(int i = 0; i < (ScreenWidth / 5) / 8; i++)
            {
                loadingText += "#";
            }
            ...
            canvas.DrawString(loadingText, PCScreenFont.Default, LoadingColor, (int)LoadPos - LoadPosSegment, ScreenHeight / 2 + 200);
        ...
        {   
            ...
            WindowManager.CreateNewWindow(WindowList, new Point(ScreenWidth / 2 - 320 / 2, ScreenHeight / 2 - 100), new Point(320, 200), new List<Color> { Color.DarkSlateGray, Color.DimGray, Color.Black, Color.FromArgb(255, 40, 65, 65) }, "Welcome to HatchOS!");
